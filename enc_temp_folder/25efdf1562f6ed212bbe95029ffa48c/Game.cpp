...
Game::Game(MainWindow& wnd)
    ...
    mov(0, 0),
    player(Object(Vec2D(56, 52), Vec2D(2, 2), 32, 48), 100, true, new Glock( 0,  1,  1,  150,  1, 1))
{
...
{
    float clock = ft.Mark();
    enemy[0]->Movement(clock, player.getObject());
    enemy[1]->Movement(clock, player.getObject());
