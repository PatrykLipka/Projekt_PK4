...
class Menu
{
	const Surface& menu = Surface("Images\\Menu.png", 1200, 800);
	const Surface& map1 = Surface("Images\\Map1_miniature.png", 240, 160);
	const Surface& map2 = Surface("Images\\Map2_miniature.png", 240, 160);
	int currentMap = 1;
