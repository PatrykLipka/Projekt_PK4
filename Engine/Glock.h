...
public:
	Glock(int neededPoints = 20, float damage = 30, float rof = 1, float distance = 200, float spread = 1, int ammo = 10000, float holdTime = 0.55f, float holdTimeOfAnimation = 0.2f);
