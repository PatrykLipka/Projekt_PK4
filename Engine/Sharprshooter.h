...
public:
	Sharpshooter(int neededPoints = 50, float damage = 30, float rof = 2, float distance = 220, float spread = 1, int ammo = 10, float holdTime = 1.5f, float holdTimeOfAnimation = 0.09f) :Weapon(neededPoints, damage, rof, distance, spread, ammo, holdTime, holdTimeOfAnimation) {}
