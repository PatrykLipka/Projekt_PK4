...
public:
	Uzi(int neededPoints=50, float damage=39, float rof=1, float distance=220, float spread=1, int ammo=30, float holdTime=0.2f, float holdTimeOfAnimation=0.09f) :Weapon(neededPoints, damage, rof, distance, spread, ammo, holdTime, holdTimeOfAnimation) {}
